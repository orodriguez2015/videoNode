var messages = {
    ...
    procesando_fotografias : "Processing photos",
    archivo_foto_permitido_1: "The file ",
    archivo_foto_permitido_2: " has a valid file format",
    archivo_foto_no_permitido: " it has an invalid file format",
    mensaje_seleccion_fotos_no_validas : "Among the selection of files made there are some that have an invalid photo format. Make a new selection.",
    imagen_incluida_album_1: "The image ",
    imagen_incluida_album_2: " has been added to the album",
    imagen_existe_album: " already exists in the album",
    fichero: "The file ",
    fichero_no_imagen: " it is not an image",
    fotografias_incluidas_album : "The photographs have been added to the album",
    mensaje_error_grabar_fotografias : "An error occurred while recording photos in database",
    mensaje_error_conexion_bbdd : "There was an error getting connection to the database",
    mensaje_error_iniciar_transaccion : "There was an error starting the transaction",
    resultados : "Results: ",
    mensaje_error_album_desconocido: "Cannot attach photos: Unknown album",
    mensaje_error_procesar_fotos : "There was an error processing the photo (s)",
